<?php
	function enqueue_scripts() {
		...
		wp_enqueue_script('custom-js', get_stylesheet_directory_uri() . '/assets/js/scripts.min.js', array('jquery'), 'v' . filemtime( get_stylesheet_directory() . '/assets/js/scripts.min.js'), true);
		...
		wp_enqueue_style('theme-style', get_stylesheet_directory_uri() . '/assets/css/styles.min.css', array(), 'v' . filemtime( get_stylesheet_directory() . '/assets/css/style.min.css'), 'all');
